...
{
    public class SingletonDecorationRepository(IDbContext dbContext, IEncrypt encrypt) : BaseMySqlUserItemRepository<UserItem>(dbContext), IDecorationRepository
    {
        protected readonly IStarRepository StarRepository = new StarMySqlRepository(dbContext);
        protected readonly IKnowledgeRepository KnowledgeRepository = new KnowledgeMySqlRepository(dbContext);
        protected readonly ICommentRepository CommentRepository = new CommentMySqlRepository(dbContext);
        protected readonly ICategoryRepository CategoryRepository = new CategoryMySqlRepository(dbContext);
        protected readonly IMarkRepository MarkRepository = new MarkMySqlRepository(dbContext);
        protected readonly IPostRepository PostRepository = new PostMySqlRepository(dbContext);
        protected readonly IUserItemRepository UserItemRepository = new UserItemMySqlRepository(dbContext);
        protected readonly ICourseRelationRepository CourseRelationRepository = new CourseRelationMySqlRepository(dbContext);
        protected readonly IUserRepository UserRepository = new UserMySqlRepository(dbContext, encrypt);
        protected readonly IUserRelationRepository UserRelationRepository = new UserRelationMySqlRepository(dbContext);
