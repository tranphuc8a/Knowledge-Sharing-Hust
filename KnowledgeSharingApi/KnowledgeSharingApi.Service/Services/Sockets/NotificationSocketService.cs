...
namespace KnowledgeSharingApi.Services.Services.Sockets
{
    public class NotificationSocketService(
        INotificationSocketSessionManager notificationSocketSessionManager,
        IResourceFactory resourceFactory,
        IEncrypt Encrypt
        ) : SocketService(notificationSocketSessionManager, resourceFactory, Encrypt), INotificationSocketService
    {
