...
namespace KnowledgeSharingApi.Services.Services.Knowledges
{
    public class QuestionService : IQuestionService
    {
        ...
        protected virtual Question CreateQuestion(ViewUserProfile user, CreateQuestionModel questionModel, string? thumbnail)
        {
        ...
        public virtual async Task<ServiceResult> UserSearchQuestionOfCourse(Guid myUid, Guid courseId, string? search, PaginationDto pagination)
        {
            ...
            List<(Guid, string, string, string?, int?, int?)> listShortPost = questions
