<template>
    <div class="p-toast p-toast-inform" ref="toast">
        <div class="p-toast-content">
            <div class="p-toast-icon">
                <Icon faClassname="pi-sprite-info" />
            </div>
...
export default {
    ...
    props: {
        description: {
            type: String,
            default: "Đây là toast thông báo"
        },
        onClose: {
            type: Function,
            default: async function(){
                console.log("Close Inform Toast");
            }
        },
        onUndo: {
            type: Function,
            default: async function(){
                console.log("Undo Inform Toast");
            }
        }
    }
}
