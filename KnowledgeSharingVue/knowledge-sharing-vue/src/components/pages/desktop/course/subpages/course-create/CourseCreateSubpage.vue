...
export default {
    ...
    methods: {
        ...
        async setInputValue(){
            try {
                await this.components.General.setValue(this.user);
                await this.components.Fee.setValue(this.user);
                await this.components.Introduction.setValue(this.user);
                await this.components.Other.setValue(this.user);
            } catch (e){
                console.error(e);
            }
        }
